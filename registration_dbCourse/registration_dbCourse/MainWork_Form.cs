       ...
       /* private void post_CB7_SelectedIndexChanged(object sender, EventArgs e)
        ...
        private void print_BUT1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= document.Sections.Count; i++)
            {
                ...
                //2
                Word.Find surnameFindObj = wordRange.Find;
                object[] surnameFindParameters = new object[15] { strToFindSurnameObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceSurnameObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                surnameFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, surnameFindObj, surnameFindParameters);

                //3
                Word.Find companyFindObj = wordRange.Find;
                object[] companyFindParameters = new object[15] {strToFindCompanyObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceCompanyObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                companyFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, companyFindObj, companyFindParameters);

                //4
                Word.Find place_inFindObj = wordRange.Find;
                object[] place_inFindParameters = new object[15] {strToFindPlace_inObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replacePlace_inObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                place_inFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, place_inFindObj, place_inFindParameters);

                //5
                Word.Find daysFindObj = wordRange.Find;
                object[] daysFindParameters = new object[15] {strToFindDaysObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceDaysObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                daysFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, daysFindObj, daysFindParameters);


                //6
                Word.Find purposeFindObj = wordRange.Find;
                object[] purposeFindParameters = new object[15] {strToFindPurposeObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replacePurposeObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                purposeFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, purposeFindObj, purposeFindParameters);


                //7 
                Word.Find baseDateFindObj = wordRange.Find;
                object[] baseDateParameters = new object[15] {strToFindBaseDateObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceBaseDateObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                baseDateFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, baseDateFindObj, baseDateParameters);

                //8 
                Word.Find baseMonthFindObj = wordRange.Find;
                object[] baseMonthParameters = new object[15] {strToFindBaseMonthObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceBaseMonthObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                baseMonthFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, baseMonthFindObj, baseMonthParameters);

                //9
                Word.Find baseYearFindObj = wordRange.Find;
                object[] baseYearParameters = new object[15] {strToFindBaseYearObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceBaseYearObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                baseYearFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, baseYearFindObj, baseYearParameters);

                //10
                Word.Find dadCompanyFindObj = wordRange.Find;
                object[] dadCompanyParameters = new object[15] {strToFindDadCompanyObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceDadCompanyObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                dadCompanyFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, dadCompanyFindObj, dadCompanyParameters);

                //11
                Word.Find day1FindObj = wordRange.Find;
                object[] day1Parameters = new object[15] {strToFindDay1Obj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceDay1Obj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                day1FindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, day1FindObj, day1Parameters);

                //12
                Word.Find month1FindObj = wordRange.Find;
                object[] month1Parameters = new object[15] {strToFindMonth1Obj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceMonth1Obj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                month1FindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, month1FindObj, month1Parameters);

                //13
                Word.Find year1FindObj = wordRange.Find;
                object[] year1Parameters = new object[15] {strToFindYear1Obj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceYear1Obj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                year1FindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, year1FindObj, year1Parameters);

                //14
                Word.Find sonCompanyFindObj = wordRange.Find;
                object[] sonCompanyParameters = new object[15] {strToFindSonCompanyObj,
                            missingObj, missingObj, missingObj, missingObj, missingObj,
                            missingObj, missingObj, missingObj, replaceSonCompanyObj,
                            replaceTypeObj,  missingObj, missingObj, missingObj,
                            missingObj };
                sonCompanyFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, sonCompanyFindObj, sonCompanyParameters);



                //18
                Word.Find endCompanyFindObj = wordRange.Find;
                object[] endCompanyParameters = new object[15] {strToFindEndCompanyObj,
                                missingObj, missingObj, missingObj, missingObj, missingObj,
                                missingObj, missingObj, missingObj, replaceEndCompanyObj,
                                replaceTypeObj,  missingObj, missingObj, missingObj,
                                missingObj };
                endCompanyFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, endCompanyFindObj, endCompanyParameters);

                //19
                Word.Find dayEndFindObj = wordRange.Find;
                object[] dayEndParameters = new object[15] {strToFindDayEndObj,
                                missingObj, missingObj, missingObj, missingObj, missingObj,
                                missingObj, missingObj, missingObj, replaceDayEndObj,
                                replaceTypeObj,  missingObj, missingObj, missingObj,
                                missingObj };
                dayEndFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, dayEndFindObj, dayEndParameters);
                
                //20
                Word.Find endMonthFindObj = wordRange.Find;
                object[] endMonthParameters = new object[15] {strToFindMonthEndObj,
                                missingObj, missingObj, missingObj, missingObj, missingObj,
                                missingObj, missingObj, missingObj, replaceMonthEndObj,
                                replaceTypeObj,  missingObj, missingObj, missingObj,
                                missingObj };
                endMonthFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, endMonthFindObj, endMonthParameters);

                //21
                Word.Find endYearFindObj = wordRange.Find;
                object[] endYeaParameters = new object[15] {strToFindYearEndObj,
                                missingObj, missingObj, missingObj, missingObj, missingObj,
                                missingObj, missingObj, missingObj, replaceYearObj,
                                replaceTypeObj,  missingObj, missingObj, missingObj,
                                missingObj };
                endYearFindObj.GetType().InvokeMember("Execute", BindingFlags.InvokeMethod, null, endYearFindObj, endYeaParameters);
                */
